#------------------------------------------------------------------------------
#  RandomInput8.py
#  Creates a random input file for CSE 101 pa8. Selects a random set of n 
#  lines from file 'English.txt' (containing 194,433 English language words), 
#  then copies them to file2. 
#  
#  To run this program, do 
#
#            python3 RandomInput8.py 
#     
#------------------------------------------------------------------------------
