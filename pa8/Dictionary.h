...
public:
   ...
   // Helper function ---------------------------------------------------------
   // Return true if A is ancestor of B, reuturn false otherwise.
   // friend bool isAncestor(Dictionary::Node* A, Dictionary::Node* B);

   // Return true if subtree of A contains key k, return false otherwise.
   friend bool containsKey(Dictionary::Node* A, Dictionary::Node* nil, keyType k);

   friend void transplant(Dictionary* D, Dictionary::Node* U, Dictionary::Node* V);
