...
int main(){
   ...
   cout << B.findNext(5) << endl;   // TODO: check this. The cursor should be move to the specific position
   cout << B << endl;
   B.eraseBefore();  // TODO: check this.
   B.eraseAfter();   // TODO: check this.
   cout << B << endl;
   ...
   cout << "A = " << A << endl;
   cout << "B = " << B << endl;  // TODO: B = (1, 6, 7, 8, 9, 10), this is wrong
                                 //       B = (3, 4, 7, 8, 9, 10), this is right
   cout << "C = " << C << endl;
   cout << "D = " << D << endl;
   cout << "E = " << E << endl;
   cout << "F = " << F << endl;
